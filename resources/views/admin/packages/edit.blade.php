...
@section('content')
    ...
    <div class="row">
        <div class="w-100 d-flex justify-content-center align-items-center mb-3">
            <img src="{{ $package->image == '' ? '/storage/avatars/default-avatar.png' : '/storage/'.$package->image }}"
                 alt="user avatar"
        ...
        <form action="{{ route('admin.package.update', $package->id) }}" method="post" enctype="multipart/form-data"
            ...
            <div class="row">
                <div class="col-6">
                    ...
                    <input type="text" class="form-control @error('name') is-invalid @enderror" id="name" name="name"
                           autofocus required value="{{ old('name', $package->name) }}">
                    @error('name')
            ...
            <div class="row mt-4">
                <div class="col-6">
                    ...
                    <input type="datetime-local" class="form-control @error('activation') is-invalid @enderror"
                           ...
                           autofocus value="{{ old('activation', $package->activation) }}">
                    @error('activation')
                    <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
                ...
                <div class="col-6">
                    ...
                    <input type="datetime-local" class="form-control @error('deactivation') is-invalid @enderror"
                           id="deactivation"
                           name="deactivation" autofocus value="{{ old('deactivation', $package->deactivation) }}">
                    @error('deactivation')
                    <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
            ...
            <div class="row mt-4">
                <div class="col-6">
                    ...
                    <input type="number" class="form-control @error('coins') is-invalid @enderror" id="coins"
                           name="coins"
                           autofocus required value="{{ old('coins', $package->coins) }}">
                    @error('coins')
                    <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
                ...
                <div class="col-6">
                    ...
                    <input type="number" class="form-control @error('count') is-invalid @enderror" id="count"
                           name="count" autofocus required value="{{ old('count', $package->count) }}">
                    @error('count')
                    <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
            ...
            <div class="row mt-4">
                <div class="col-6">
                    ...
                    <input type="number" class="form-control @error('price') is-invalid @enderror" id="price"
                           name="price"
                           autofocus required value="{{ old('price', $package->price) }}">
                    @error('price')
                    <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
                ...
                <div class="col-6">
                    ...
                    <input type="number" class="form-control @error('counted_price') is-invalid @enderror"
                           ...
                           value="{{ old('counted_price', $package->counted_price) }}">
                    @error('counted_price')
                    <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
            ...
            <button type="submit" class="btn btn-success mt-4 mb-5">{{ __('titles.edit_package') }}</button>
        </form>
    </div>
@endsection
